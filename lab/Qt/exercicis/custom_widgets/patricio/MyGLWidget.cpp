...
void MyGLWidget::viewTransform() {  
    ...
    */
    ...
    View = glm::rotate(View, thita, glm::vec3(1.0,0.0,0.0));
...
void MyGLWidget::ini_camera() {
    ...
    OBS = VRP + d*glm::vec3(1,0,0); //Coordenades del punt de l'observador
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) {
    ...
    switch (event->key()) {
        ...
        case Qt::Key_Z:
            FOV -= 0.1;
            //actualitzem alpha_ini per evitar 
            alpha_ini = FOV/2;
            projectTransform();
            break;
        case Qt::Key_X:
